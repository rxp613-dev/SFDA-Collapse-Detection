...
def analyze_jnu_dataset():
    ...
    for csv_file in csv_files:
        ...
        try:
            ...
            print(f"      非零值比例: {100*non_zero/total:.2f}%")
    ...
    # 5. 保存分析结果
    output_path = PROJECT_ROOT / 'prai2026' / 'paper2' / 'experiments' / 'results' / 'revision' / 'task_A1_1_jnu_dataset_analysis.json'
