#!/usr/bin/env python3
"""
Task A1.5 with Complementary Signals (JNU Main Audit)
Created: 2026-08-08
Purpose: 在原A1.5基础上，额外保存预测概率和特征，用于计算互补信号
...
def main():
    print("=" * 80)
    print("Task A1.5 with Complementary Signals (JNU Main Audit)")
    print("=" * 80)
    ...
    results = {
        'task': 'A1.5-with-signals',
        'description': 'JNU Main Audit with Complementary Signals',
        'timestamp': datetime.now().strftime('%Y-%m-%d %H:%M:%S'),
        'note': 'Includes prediction entropy and feature norm',
        'snr_levels': {}
    }
    ...
    out_file = RESULTS_DIR / 'task_A1_5_with_signals.json'
